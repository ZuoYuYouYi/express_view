<template>
  <div>
    <divider style="font-size: 30px">修改通知手机号</divider>
    <group title="当前通知手机号">
      <x-input title="手机号" v-model="nowMobileNumber" novalidate disabled style="height: 36px"
    ...
    <group title="修改通知手机号">
      <x-input title="手机号" v-model="updateMobileNumber" placeholder="请输入手机号" novalidate
               :show-clear="true" @on-blur="updatePhoneReg" style="height: 36px"
